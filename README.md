...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1381&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-munsell-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-munsell` can be installed with `conda`:
...
```
mamba install r-munsell
```

It is possible to list all of the versions of `r-munsell` available on your platform with `conda`:
...
```
mamba search r-munsell --channel conda-forge
```
...
mamba repoquery search r-munsell --channel conda-forge

# List packages depending on `r-munsell`:
mamba repoquery whoneeds r-munsell --channel conda-forge

# List dependencies of `r-munsell`:
mamba repoquery depends r-munsell --channel conda-forge
```
